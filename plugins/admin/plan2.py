...
@Client.on_message(filters.command("sub2", prefixes=["/", "."]))
async def cmd_plan2(client: Client, message: Message):
    ...
    try:
        ...
        await client.send_message(int(userid), user_message, )

    except ValueError:
        await message.reply_text("⚠️ <b>Usage:</b> <code>/sub2 user_id payment_method</code>", quote=True, )
