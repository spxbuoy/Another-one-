...
async def cmd_sf(client, message):
    try:
        ...
        cc = message.reply_to_message.text if message.reply_to_message else message.text[len('/sf '):].strip()
...
""")
        ...
        payload = {
            ...
            "data": {
                "card": fullcc,
                "product_url": "http://smallbizshippingco.com/products/tiktok-live-focal-sale",
                "email": None,
