...
@Client.on_message(filters.command("as", prefixes=["/", "."]), group=92)
async def cmd_as(client, message):
    try:
        ...
        if not cc_text:
            return await message.reply("❌ Usage: /as <cc|mm|yy|cvv>")
        ...
        try:
            async with httpx.AsyncClient(timeout=30) as http_client:
                ...
                payload = {
                    ...
                    "data": {
                        "card": fullcc,
                        "product_url": "https://www.currenwatches.com/products/routeins",
                        "email": None,
                        "proxy": "23.94.138.75:6349:pyrcqush:elcth08m9maj",
                        "ship_address": None,
                        "is_shippable": False
                    }
                }
