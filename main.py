...
async def main():
  ...
  bot = Client("my_bot",
               api_id="7679023904",
               api_hash="93de73c78293c85fd6feddb92f91b81a",
               bot_token="8156458632:AAEkVYPYPm9yL3Tz9eCqYctQ7m5qL8C1N88",
               plugins=plugins)
  clients = [user, bot]
...
<code>/scr https://t.me/+aGWRGz 50</code>
      ...
      if results == 'None':
        ...
        if chat_type == "ChatType.PRIVATE" and status == "FREE":
          resp = "𝗢𝗡𝗟𝗬 𝗣𝗥𝗘𝗠𝗜𝗨𝗠 𝗠𝗘𝗠𝗕𝗘𝗥𝗦 𝗔𝗥𝗘 𝗔𝗟𝗟𝗢𝗪𝗘𝗗 𝗧𝗢 𝗨𝗦𝗘 𝗕𝗢𝗧 𝗜𝗡 𝗣𝗘𝗥𝗦𝗢𝗡𝗔𝗟 ⚠️.𝗬𝗢𝗨 𝗖𝗔𝗡 𝗨𝗦𝗘 𝗙𝗥𝗘𝗘𝗟𝗬 𝗕𝗢𝗧 𝗛𝗘𝗥𝗘 @BarryxChat"
          await message.reply_text(resp, message.id)

        elif chat_type == "ChatType.GROUP" or chat_type == "ChatType.SUPERGROUP" and chat_id not in GROUP:
          resp = "𝗨𝗡𝗔𝗨𝗧𝗛𝗢𝗥𝗜𝗭𝗘𝗗 𝗖𝗛𝗔𝗧 ❌. 𝗖𝗢𝗡𝗧𝗔𝗖𝗧 @Barry_op 𝗧𝗢 𝗔𝗨𝗧𝗛𝗢𝗥𝗜𝗭𝗘."
          await message.reply_text(resp, message.id)
        else:
          #CREDIT CHECK
...
[ϟ] Bot By: <a href=\"tg://user?id=6440962840\">𝑩𝑨𝑹𝑹𝒀</a>
━━━━━━━━━━━━━━━━━━
"""
                  document = file_name
...
[ϟ] Duplicates: <code>{dublicate}</code>
[ϟ] User: <a href=\"tg://user?id={message.from_user.id}\">{message.from_user.first_name}</a> [{status}]
[ϟ] Bot By: <a href=\"tg://user?id=644096284\">𝑩𝑨𝑹𝑹𝒀</a>
━━━━━━━━━━━━━━━━━━
"""
                  document = file_name
                  scr_done = await message.reply_document(
